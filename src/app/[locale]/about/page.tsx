    ...
    <div className="mx-auto max-w-4xl space-y-14">
      ...
      <section className="rounded-2xl bg-ink-50 p-6 sm:p-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          {/*
            /drive, not /driver. The second is the signed-in driver console:
            its layout redirects a visitor with no session straight to
            /login?next=/driver, so the biggest button on this page sent every
            prospective driver to a password form for an account they do not
            have, and none of them ever reached the application. The public page
            that takes applications is /{locale}/drive.
          */}
          <Link
            href={`/${locale}/drive`}
